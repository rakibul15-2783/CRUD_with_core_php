							...
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" name="name" value="<?php echo $alldata['name']; ?>" class="category-name form-control" id="category-name" placeholder="Enter Product Name">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputPhoneNo2" class="col-sm-3 col-form-label">Product Description</label>
										<div class="col-sm-9">
											<input type="text" name="des" value="<?php echo $alldata['des']; ?>" class="category-des form-control" id="category-des" placeholder="Product Description">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputEmailAddress2" class="col-sm-3 col-form-label">Price</label>
										<div class="col-sm-9">
											<input type="text" name="price" value="<?php echo $alldata['price']; ?>" class="category-price form-control" id="category-price" placeholder="Price">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<button type="submit" name="btn" class="category-add btn btn-info px-5">Update</button>
